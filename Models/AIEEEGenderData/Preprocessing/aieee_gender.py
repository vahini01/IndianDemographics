...
def AIEEEGenderData():
  ...
  ai11 = pd.read_csv(AIEEE_2011_CSV)
  ai09 = pd.read_csv(AIEEE_2009_CSV)
  g10 = getParentsData(ai10)
  g11 = getParentsData(ai11)
  g09 = getParentsData(ai09)
  caste_df = pd.concat([g10, g11, g09], ignore_index=True)
  # Add Majority Label
  caste_df = processDf(caste_df)
  caste_df = addFrequency(caste_df)
  caste_df = useMajorityLabel(caste_df)
  ...
  final_df = pd.DataFrame()
  final_df['Name'] = caste_df['Name']
  final_df['Gender'] = caste_df['new_labels']
  return final_df
